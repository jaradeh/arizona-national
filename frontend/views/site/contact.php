...
<!-- Inner Banner -->
<div class="inner-banner overlay-dark" data-enllax-ratio="-.3" style="background: url(/images/banner/banner_sector_construction.jpg) no-repeat fixed;">
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xs-12">
                        <div class="contact-widget">
                            ...
                            <div class="address-box after-clear">
                                <ul>
                                    <li>
                                        ...
                                        <span>+965 24 330 080</span>
                                    </li>
                                    <li>
                                        <h4><?= yii::t('app', 'Fax'); ?></h4>
                                        <span>+965 24 330 085</span>
                                    </li>
                                    <li>
                                        <h4><?= yii::t('app', 'email'); ?></h4>
                                        <span><a href="mailto:info@arizona-national.com?Subject=Hello" target="_top">info@arizona-national.com</a></span>
                                    </li>
                                    <li>
                            ...
                            <p>Working hours is from 8:00am - 6:00 pm <br>Sunday to Thursday, and 9:00am - 2:00pm on Saturday.</p>
                            <div class="address-box map-img after-clear">
                                ...
                                <div class="address-widget">
                                    <p>P. O. Box 20575 Safat Postal Code 13061 Kuwait</p>
                                </div>
                            </div>
                            <p></p>
