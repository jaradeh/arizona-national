            ...
            <div class="col-md-6 contact-info">   
                <div class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="lable">Username <span>*</span></div>
                        ...
                        <div class="col-md-8">
                            <p class="comment-form-forget-password">
                                <?= Html::a('If you forgot your password you can reset it', ['site/request-password-reset']) ?>
                            </p>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <p class="form-submit">
                                <?= Html::submitInput('Login', ['id' => 'submit', 'class' => 'btn btn-secondary', 'name' => 'login-button']) ?>
                            </p> 
                        </div>                      
                    </div>                              
                    <?php ActiveForm::end(); ?>
